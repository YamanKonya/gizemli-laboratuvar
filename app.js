    ...
    kimya: {
        ...
        stations: [
            ...
            },
            {
                ...
                nextStationName: "Final İstasyonu"
            },
            {
                id: 16,
    ...
    matematik: {
        ...
        stations: [
            ...
            },
            {
                ...
                hint: "Nokta, çizgi, açı, yüzey ve cisimlerin özelliklerini inceleyen matematik dalı.",
                answers: ["geometri"],
    ...
    bilisim: {
        ...
        stations: [
            ...
            },
            {
                ...
                hint: "Topladığın 10 harfi (A-L-A-N-T-U-R-İ-N-G) birleştirerek yapay zekanın mucidi kabul edilen matematikçinin adını yazmalısın.",
...
class ScavengerEscapeGame {
    ...
    openTeacherPanel() {
        ...
        data.stations.forEach(s => {
            if (s.id === data.stations.length) return; // Final Anagram adımı için QR kod basılması gerekmez
